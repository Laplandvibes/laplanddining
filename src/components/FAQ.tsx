                          ...
                          <div className="flex flex-wrap gap-x-5 gap-y-2 mt-4">
                            {FAQ_LINKS[index].map((key) => (
                              <Link
                                key={key}
                                to={to(FAQ_ROUTE[key])}
                                className="lv-tap inline-flex items-center gap-1.5 text-xs sm:text-sm font-semibold uppercase tracking-wider text-amber hover:text-vibe-pink transition-colors"
                              >
