...
export const restaurantOverrides: Record<string, Override> = {
  ...
  'ChIJvySHpvNLK0QRY-dnGYTVum4': {
    ...
    curatedDescription: {
      ...
      ja: 'ロヴァニエミの中心にたたずむ山小屋。Nili は二十年以上にわたりラップランドの味を届けてきました。トナカイのソテー、北極イワナ、クラウドベリーのデザート。はじめの一皿には4品のおまかせコースがおすすめです。',
      es: 'Una cabaña en plena naturaleza, en el corazón de Rovaniemi. Nili lleva más de veinte años sirviendo sabores de Laponia: reno salteado, salvelino ártico y postres de mora ártica. El menú sorpresa de cuatro platos es la mejor manera de empezar.',
  ...
  'ChIJd2up905N0kURTWJBTBizK7A': {
    ...
    curatedDescription: {
      ...
      ja: '直火のそばで燻したサーモンが、その夜いちばんの瞬間。ホールではなく、コタのなかで火にかけて仕上げられます。',
      ...
      ko: '불 옆에서 훈제한 연어가 그날 저녁의 백미입니다. 홀이 아니라 코타 안에서, 불을 마주하고 완성됩니다.',
  ...
  'ChIJTV_WZOkVzUURy3OSF3ioobg': {
    curatedDescription: {
      ...
      es: 'Caminatas, motos de nieve y tradición sami: el salmón se asa al fuego abierto y el sabor se queda con usted toda la noche.',
  ...
  'ChIJfwLqSC5L1UURbXQMTAr-hNc': {
    curatedDescription: {
      ...
      es: 'Sopa de salmón y reno salteado: dos clásicos de Laponia, ambos preparados con esmero.',
  ...
  'ChIJia3ekmY-1UURpiwLrRRqEa4': {
    curatedDescription: {
      ...
      es: 'El río Tornio pasa justo al lado de su mesa y, al salir, puede llevarse pescado ahumado en la casa: un detalle que hace la velada única.',
  ...
  'ChIJP39o0c5UKUQR-WqaWDdvYM0': {
    ...
    curatedDescription: {
      ...
      es: 'De esas pizzerías en las que entra de casualidad y sale diciendo guau. Un favorito sencillo y de fiar al pie de Ruka.',
  ...
  'ChIJaxo1dZ5H1UUR3eIxu_vnRbY': {
    ...
    curatedDescription: {
      ...
      ja: '「メニューが豊富でビールもうまい」と、あるレビューは言い切ります。トルニオでの夕食にちょうどいい、気取らない地元の溜まり場です。',
      ...
      ko: '한 리뷰의 말처럼, 메뉴 선택이 다양하고 맥주도 좋습니다. 토르니오에서 저녁을 즐기기 좋은 편안한 동네 아지트입니다.',
  ...
  'ChIJPx28EWHPLEQRiwFudZhTkdw': {
    curatedDescription: {
      ...
      es: 'El comedor de madera de kelo del hotel de Luosto, donde los platos típicos de Laponia se sirven bajo un techo de troncos al pie del fell.',
      ...
      fr: 'La salle en bois de kelo de l\'hôtel de Luosto, où les plats typiques de Laponie sont servis sous un toit de rondins, au pied de la fjeld.',
      it: 'La sala in legno di kelo dell\'hotel di Luosto, dove i piatti tipici della Lapponia arrivano sotto un tetto di tronchi ai piedi della fjeld.',
