...
export const restaurantOverrides: Record<string, Override> = {
  ...
  'ChIJdUzUC3vqLEQRdUuWbK803p0': {
    ...
    curatedDescription: {
      ...
      fr: 'Une bonne cuisine et une ambiance simple et chaleureuse, portée par une équipe qui travaille manifestement dur. Une halte accueillante au pied du fjell.',
